...
var userTuple = [user1, 1];
function fetchFromEmail(email) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    parsed = _a.sent();
                    user = parsed.find(function (u) { return u.email === email; });
                    if (user) {
                        return [2 /*return*/, fetchFromId(user.id)];
                    }
